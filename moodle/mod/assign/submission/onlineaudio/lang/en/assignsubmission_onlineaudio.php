...
$string['defaultname1'] = 'First_Default_Name';
$string['defaultname2'] = 'Second_Default_Name';
$string['allownameoverride'] = 'Allow the name to be overwritten';
$string['nodefaultname'] = 'No_Default_Name';